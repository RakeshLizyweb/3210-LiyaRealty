...
import TvhSer from '../images/tvhserenity-1.jpg';


const LandingTvhSerenity = () => {
    ...
    <div className="liya-realty">
       ...
       <section className="hero" ref={heroRef}>
        ...
        <div className="hero-inner">
         <div>
            ...
            <h1 id="heroHeadline">
                Premium <span className="underline-draw">2 BHK Apartments</span>
                <br />
                <em>at TVH Serenity, Avinashi</em>
            </h1>

            <p className="lead">
                Experience comfortable modern living at TVH Serenity in Avinashi, Coimbatore.
                Spacious 2 BHK apartments with premium amenities, excellent connectivity, and
                thoughtfully designed homes starting from ₹56.5 Lakhs.
            </p>
          ...
          <div className="seal-card tilt" >
            <img src={TvhSer} className='hero-img' alt="image"></img>
          </div>
        </div>
      </section>
      ...
      <div className="marquee-wrap">
        <div className="marquee-track" id="marqueeTrack">
            <span>Premium 2 BHK Apartments</span>
            <span>TVH Serenity</span>
            <span>Avinashi, Coimbatore</span>
            <span>Modern Amenities</span>
            <span>Starting ₹56.5 Lakhs</span>
      ...
      <section className="values" id="values">
        <div className="container">
          <div className="section-head reveal">
            <div className="eyebrow">Why Choose TVH Serenity</div>

            <h2>Designed for comfortable family living</h2>

            <p>
            TVH Serenity combines quality construction, modern amenities, and a prime location
            to offer a lifestyle that is both comfortable and rewarding.
            </p>
        ...
        <div className="values-grid reveal-stagger reveal">
          ...
          <div className="value-card stagger-item">
           ...
           <h3>Prime Location</h3>
            ...
            <p>
            Located in Avinashi, Coimbatore with excellent connectivity to schools,
            colleges, hospitals, and major business hubs.
            </p>
          </div>
          ...
          <div className="value-card stagger-item">
           ...
           <h3>Modern Living</h3>
            ...
            <p>
            Thoughtfully planned 2 BHK apartments featuring efficient layouts,
            natural ventilation, and comfortable living spaces.
            </p>
          </div>
          ...
          <div className="value-card stagger-item">
           <span className="vnum">Value</span>
            ...
            <p>
            Enjoy a secure gated community with landscaped gardens, play areas,
            and lifestyle amenities for every family.
            </p>
          </div>
          ...
          <div className="value-card stagger-item">
           ...
           <h3>Great Investment</h3>
            ...
            <p>
            An excellent opportunity for homebuyers and investors seeking
            long-term value in one of Coimbatore's growing residential locations.
            </p>
          </div>
          ...
          <div className="value-card stagger-item">
            ...
            <p>
            Round-the-clock security, CCTV surveillance, and gated access provide
      ...
      <section className="about" id="about">
        <div className="container about-inner reveal">
          ...
          >
            <div className="blueprint"><img src={TvhSer} className='blueprint-img'></img></div>
            <div className="mark">
          ...
          <div>
             <h2>
            Discover a home built for <em>everyday comfort.</em>
            </h2>

            <p>
            TVH Serenity offers beautifully designed 2 BHK apartments that blend
            modern architecture with functional living spaces. Located in Avinashi,
            the project provides a peaceful lifestyle with easy access to the city's
            major destinations, making it ideal for families and working professionals.
            </p>
            <div className="about-pillars">
              <span className="pill">2 BHK Apartments</span>
              <span className="pill">868–1055 Sq.ft</span>
        ...
        <div className="container">
          <div className="section-head reveal">
           <div className="eyebrow">Project Highlights</div>
            ...
            <h2>Everything you need for modern apartment living</h2>

            <p>
            TVH Serenity offers spacious apartments with quality amenities,
            secure surroundings, and excellent connectivity for everyday convenience.
            </p>
          </div>
        </div>
        ...
        <div className="service-grid reveal-stagger reveal">
          <div className="service-card stagger-item">
           ...
           <span className="stag">Configuration</span>
            ...
            <h3>Premium 2 BHK Apartments</h3>

            <p>
            Well-designed apartments offering spacious interiors and practical layouts
          ...
          <div className="service-card stagger-item">
           ...
           <span className="stag">Apartment Size</span>

            <h3>868 – 1055 Sq.ft</h3>

            <p>
            Choose from thoughtfully planned apartment sizes that maximize
            space, comfort, and functionality.
            </p>
          </div>
          ...
          <div className="service-card stagger-item">
           ...
           <span className="stag">Pricing</span>
            ...
            <h3>Starting from ₹56.5 Lakhs</h3>

            <p>
            Attractive pricing makes TVH Serenity an excellent choice for
          ...
          <div className="service-card stagger-item">
           ...
           <span className="stag">Amenities</span>
            ...
            <h3>Lifestyle Facilities</h3>

            <p>
            Children's play area, landscaped gardens, covered parking,
            lift facility, and power backup for everyday convenience.
            </p>
          </div>
          ...
          <div className="service-card stagger-item">
           ...
           <span className="stag">Security</span>
            ...
            <p>
            24×7 security with CCTV surveillance ensures a secure
        ...
        <div className="container why-inner reveal">
          <div>
            ...
            <ul className="why-list">
              <li>
                ...
                <h3>Trusted Residential Project</h3>

                <p>
                Developed with a focus on quality construction, comfort,
                and long-term value.
                </p>
              ...
              <li>
                ...
                <p>
                Located in Avinashi with seamless access to major roads,
              ...
              <li>
                ...
                <div>
                    ...
                    <p>
                    A secure community featuring modern amenities and thoughtfully
                    planned living spaces for everyday comfort.
                    </p>
          ...
          <div className="why-card tilt" ref={(el) => cardTiltRefs.current.push(el)}>
           ...
           <h3>Book your exclusive site visit today</h3>
            ...
            <p>
            Liya Realty is your trusted channel partner for TVH Serenity.
            Contact us to know about apartment availability, pricing,
            floor plans, and exclusive offers.
            </p>
...
export default LandingTvhSerenity;
