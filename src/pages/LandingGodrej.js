...
import GodOne from '../images/godrej-1.jpg';
import GodTwo from '../images/godrej-2.jpg';
    ...
    <div className="liya-realty">
      ...
      <div id="scrollbar" style={{ }}></div>
       ...
       <section className="hero" ref={heroRef}>
        ...
        <div className="hero-inner">
          <div>
            <div className="eyebrow hero-eyebrow">Liya Realty | Godrej Plots</div>

            <h1 id="heroHeadline">
              Own Premium <span className="underline-draw">Godrej Plots</span>
              <br />
              <em>Opposite Coimbatore Golf Club</em>
            </h1>

            <p className="lead">
              Discover premium plotted developments by Godrej in Coimbatore.
              Choose from spacious plots ranging from 1.5 to 6 cents and build your dream home
              in a gated community with world-class amenities and excellent connectivity.
            </p>
          ...
          <div className="seal-card tilt" >
            <img src={GodOne} className='hero-img' alt="image"></img>
          </div>
        </div>
      </section>
      ...
      <div className="marquee-wrap">
        <div className="marquee-track" id="marqueeTrack">
          <span>Godrej Plots</span>
          <span>Premium Gated Community</span>
          <span>1.5 to 6 Cent Plots</span>
          <span>Near Coimbatore Golf Club</span>
      ...
      <section className="values" id="values">
        <div className="container">
          <div className="section-head reveal">
           <div className="eyebrow">Why Choose Godrej</div>

            <h2>Designed for modern living and long-term value</h2>
            <p>
            Experience thoughtfully planned plots backed by the trust of the Godrej brand,
            offering an ideal balance of lifestyle, connectivity, and future appreciation.
            </p>
        ...
        <div className="values-grid reveal-stagger reveal">
          ...
          <div className="value-card stagger-item">
            ...
            <p>
              Strategically located opposite Coimbatore Golf Club with seamless access to major roads,
              schools, IT parks, and healthcare facilities.
            </p>
          </div>
          ...
          <div className="value-card stagger-item">
            ...
            <p>
            Invest confidently in a premium plotted development from one of India's most respected
          ...
          <div className="value-card stagger-item">
           ...
           <h3>Luxury Lifestyle</h3>
            ...
            <p>
            Enjoy landscaped surroundings, premium amenities, clubhouse facilities,
            and a secure gated environment for your family.
            </p>
          </div>
          ...
          <div className="value-card stagger-item">
            ...
            <p>
            Located in one of Coimbatore's rapidly developing investment corridors with
          ...
          <div className="value-card stagger-item">
            ...
            <p>
            Experience peace of mind with 24×7 security, well-planned infrastructure,
      ...
      <section className="about" id="about">
        <div className="container about-inner reveal">
          ...
          >
            <div className="blueprint"><img src={GodTwo} className='blueprint-img'></img></div>
            <div className="mark">
          ...
          <div>
              <h2>
              Build your dream home with the <em>Godrej legacy.</em>
              </h2>

              <p>
              Godrej Plots Coimbatore offers premium residential plots designed for families
              and investors seeking a perfect blend of nature, connectivity, and modern
              infrastructure. Whether you're building today or investing for tomorrow,
              this project delivers exceptional long-term value.
              </p>
            <div className="about-pillars">
              <span className="pill">Premium Plots</span>
              <span className="pill">Gated Community</span>
              <span className="pill">Club House</span>
              <span className="pill">24×7 Security</span>
              <span className="pill">Excellent Connectivity</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="services" id="services">
        <div className="container">
          <div className="section-head reveal">
           <div className="eyebrow">Project Highlights</div>
            ...
            <h2>Everything you need in one premium community</h2>

            <p>
            Carefully planned plots with world-class amenities in one of Coimbatore's
            most promising residential destinations.
            </p>
          </div>
        </div>
        ...
        <div className="service-grid reveal-stagger reveal">
          <div className="service-card stagger-item">
            ...
            <span className="stag">Plot Sizes</span>

            <h3>1.5 to 6 Cent Plots</h3>

            <p>
            Choose from multiple plot dimensions designed to suit different lifestyle and investment goals.
            </p>
          </div>
          ...
          <div className="service-card stagger-item">
            ...
            <h3>Starting from ₹18 Lakhs*</h3>

            <p>
            Competitive launch pricing with attractive investment opportunities and flexible payment options.
            </p>
          </div>
          ...
          <div className="service-card stagger-item">
            ...
            <span className="stag">Development</span>

            <h3>44 Acres Township</h3>

            <p>
            A thoughtfully planned community featuring over 800 premium residential plots.
            </p>
          </div>
          ...
          <div className="service-card stagger-item">
            ...
            <h3>Premium Lifestyle Facilities</h3>

            <p>
            Clubhouse, landscaped parks, children's play area, walking tracks, and more for everyday comfort.
            </p>
          </div>
          ...
          <div className="service-card stagger-item">
            ...
            <span className="stag">Connectivity</span>

            <h3>Excellent Location Advantage</h3>

            <p>
            Only 20 minutes from Coimbatore Airport with easy access to schools, hospitals, and IT hubs.
            </p>
          </div>
          ...
          <div className="service-card stagger-item">
            ...
            <h3>Safe Gated Community</h3>

            <p>
            24×7 monitored security with entrance control and professionally maintained surroundings.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container why-inner reveal">
          <div>
            <div className="section-head" style={{ marginBottom: '36px' }}>
              ...
              <h2>Reasons to invest in Godrej Plots Coimbatore</h2>
            ...
            <ul className="why-list">
              <li>
                ...
                <p>
                Situated opposite Coimbatore Golf Club in a rapidly developing residential corridor.
                </p>
              ...
              <li>
                ...
                <p>
                  Developed by Godrej, known for delivering high-quality residential communities across India.
                </p>
              ...
              <li>
                ...
                <div>
                 ...
                 <h3>Excellent Investment Potential</h3>

                  <p>
                    Ideal for both home construction and long-term appreciation in one of Coimbatore's fastest-growing areas.
                  </p>
          ...
          <div className="why-card tilt" ref={(el) => cardTiltRefs.current.push(el)}>
            ...
            <h3>Schedule your exclusive site visit</h3>

            <p>
            Liya Realty is your trusted channel partner for Godrej Plots Coimbatore.
            Connect with our experts for pricing, availability, floor plans, and guided site visits.
            </p>
      ...
      <section className="cta" id="contact">
        ...
        <div className="container cta-inner reveal">
          ...
          <h2>
            Reserve your <em>Godrej Plot</em> before the next price revision.
          </h2>
          <p>Contact Liya Realty for the latest pricing, plot availability, brochure, and exclusive launch offers.</p>
